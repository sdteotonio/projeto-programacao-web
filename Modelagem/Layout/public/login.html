...
<body>
    <div class="login-clean">
        <form method="post" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="illustration"><i class="fa fa-book"></i>
            ...
            <div class="form-group"><input class="form-control" type="text" name="user" placeholder="Usuário"></div>
            <div class="form-group"><input class="form-control" type="password" name="pass" placeholder="Senha"></div>
